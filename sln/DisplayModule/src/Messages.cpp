...
std::string GetShapeTypeFrom(const ShapeType st) {
    ...
    switch (st) {
        case RECTANGULAR_PRISM:
            ret = "RectangularPrism";
            break;
        case TRIANGULAR_PRISM:
            ret = "TriangularPrism";
            break;
        case TRAPEZOIDAL_PRISM:
            ret = "TrapezoidalPrism";
            break;
        case CYLINDER:
            ret = "Cylinder";
            break;
...
std::ostream &operator<<(std::ostream &oss, const ShapeInit &si) {
    ...
    switch (si.type) {
        case RECTANGULAR_PRISM:
            oss << si.params.rect.xlen << "," << si.params.rect.ylen << "," << si.params.rect.zlen;
            break;
        case TRIANGULAR_PRISM:
            oss << si.params.tri.alen << "," << si.params.tri.angle << "," << si.params.tri.blen << "," << si.params.tri.depth;
            break;
        case TRAPEZOIDAL_PRISM:
            oss << si.params.trap.alen << "," << si.params.trap.aoff << "," << si.params.trap.blen << "," << si.params.trap.depth << "," << si.params.trap.height;
            break;
        case CYLINDER:
            oss << si.params.cyl.depth << "," << si.params.cyl.radius;
            break;
    }
